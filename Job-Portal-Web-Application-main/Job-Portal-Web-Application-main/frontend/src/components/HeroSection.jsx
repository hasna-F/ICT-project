    ...
    return (
        <div className="text-center py-16 bg-gradient-to-r from-blue-50 to-blue-100">
            <div className="flex flex-col items-center gap-8 my-10">
                <span className="px-6 py-3 rounded-full bg-red-100 text-red-500 font-medium text-sm">
                    Welcome to ict jobportal 
                </span>
                ...
                <div className="flex w-full max-w-2xl shadow-xl border border-gray-300 bg-white pl-4 pr-2 py-3 rounded-full items-center gap-4 transition-transform transform hover:scale-105">
                    <input
                        ...
                        className="outline-none border-none w-full text-lg text-gray-700 placeholder-gray-500 focus:ring-2 focus:ring-indigo-400"
                    />
                    <Button 
