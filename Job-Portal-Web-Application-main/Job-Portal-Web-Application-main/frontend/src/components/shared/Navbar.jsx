            ...
            <div className="flex items-center justify-between mx-auto max-w-7xl h-16 px-6">
                <div>
                    <h1 className="text-3xl font-extrabold text-white">
                        Ict<span className="text-yellow-300"> Jobseeker</span>
                    </h1>
                </div>
                <div className="flex items-center gap-8">
                    <ul className="flex font-medium items-center gap-6 text-white">
                        {user && user.role === 'recruiter' ? (
                            ...
                            <>
                                ...
                                <li>
                                    <Link to="/jobs" className="hover:text-yellow-300 transition-colors">
                                        Jobs
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/browse" className="hover:text-yellow-300 transition-colors">
                                        Browse
                                    </Link>
                                </li>
                            </>
                    ...
                    {!user ? (
                        <div className="flex items-center gap-3">
                            <Link to="/login">
                                <Button variant="outline" className="border-gray-200 text-white hover:bg-gray-100 hover:text-indigo-600">
                                    Login
                                </Button>
                            </Link>
                            <Link to="/signup">
                            ...
                            <PopoverContent className="w-64 bg-white shadow-md rounded-lg">
                                <div className="p-4">
                                    <div className="flex items-center gap-3 mb-4">
                                        <Avatar className="cursor-pointer">
                                            <AvatarImage src={user?.profile?.profilePhoto} alt="User Profile Photo" />
                                        </Avatar>
                                        <div>
